...
-- store the results in the folder /user/hadoop/example-results (or whatever else)
store count_by_object_ordered into '/user/hadoop/problem-1-results' using PigStorage();
